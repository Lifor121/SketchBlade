...
namespace SketchBlade.ViewModels
{
    public class RelayCommand : ICommand
    {
        ...
        public void Execute(object? parameter)
        {
            ...
            {
                MessageBox.Show($"RelayCommand({_commandName}).Execute({parameter}) - ERROR: {ex.Message}");
    ...
    public class RelayCommand<T> : ICommand
    {
        ...
        public void Execute(object? parameter)
        {
            ...
            {
                MessageBox.Show($"RelayCommand<{typeof(T).Name}>({_commandName}).Execute({parameter}) - ERROR: {ex.Message}");
                MessageBox.Show($"Stack trace: {ex.StackTrace}");
                throw;
            }
        }
